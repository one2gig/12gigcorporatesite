...
export const ms: Dictionary = {
  ...
  home: {
    ...
    heroTitleBefore: 'Menghubungkan Kemahiran dengan',
    heroTitleHighlight: 'Peluang Pendapatan',
    heroTitleAfter: '',
    heroSubtitle:
  ...
  sme: {
    ...
    titleBefore: 'Penyelesaian Digital untuk',
    titleHighlight: 'PKS',
    intro:
      'Kami membantu perniagaan tempatan Malaysia beralih daripada aliran kerja manual kepada sistem digital yang cekap, automatik, dan berpusatkan manusia.',
    bookConsultation: 'Tempah Perundingan Percuma',
    problemsTitleBefore: 'Kos Menjalankan Perniagaan secara',
    problemsTitleHighlight: 'Manual',
    problemsIntro:
      'PKS tempatan berdepan kekangan digital yang menghalang pertumbuhan.',
    problems: [
      { title: 'Kekacauan WhatsApp', desc: 'Pesanan dan butiran hilang dalam sembang yang berselerak.' },
      { title: 'Operasi Manual', desc: 'Membazir jam untuk kerja kertas berulang yang mudah tersilap.' },
      { title: 'Kehadiran Lemah', desc: 'Tiada imej profesional untuk pelanggan yang berpotensi global.' },
      { title: 'Tiada Data', desc: 'Beroperasi tanpa analitik perniagaan yang sebenar.' },
    ],
    briefingAlt: 'Taklimat pasukan',
    stackTitle: 'Tumpukan Penyelesaian Kami',
    stackIntro: 'Kami bukan sekadar membina laman web; kami membina enjin pertumbuhan perniagaan.',
    services: [
      {
        title: 'Laman Web Korporat',
        desc: 'Kehadiran pantas dan dioptimumkan SEO untuk membina kredibiliti jenama anda.',
      },
      {
        title: 'Aplikasi Web Tersuai',
        desc: 'Alatan khusus yang sesuai dengan aliran kerja perniagaan anda.',
      },
      {
        title: 'Sistem Tempahan',
        desc: 'Temujanji dan penjadualan automatik untuk penyedia perkhidmatan.',
      },
      {
        title: 'Portal Pesanan',
        desc: 'Sistem pesanan terus kepada pelanggan untuk mengurangkan komisen pihak ketiga.',
      },
      {
        title: 'Sistem Dalaman',
        desc: 'Pengurusan inventori dan portal kakitangan untuk operasi yang lancar.',
      },
      {
        title: 'AI & Automasi',
        desc: 'Chatbot pintar dan pencetus aliran kerja untuk menjimatkan masa.',
      },
    ],
    whyTitle: 'Mengapa PKS Tempatan Memilih 12gig',
    reasons: [
      {
        title: 'Konteks Tempatan',
        desc: 'Kami memahami budaya perniagaan Malaysia dan keperluan pasaran yang unik.',
      },
      {
        title: 'Harga Berpatutan',
        desc: 'Teknologi tidak sepatutnya membebankan. Kami tawarkan harga PKS yang fleksibel.',
      },
      {
        title: 'Lincah & Pantas',
        desc: 'Kami menyampaikan hasil dalam minggu, bukan bulan, menggunakan teknologi moden.',
      },
      {
        title: 'Berpusatkan Manusia',
        desc: 'Kami membina untuk kakitangan dan pelanggan anda, supaya ia mudah diguna.',
      },
    ],
    processTitleBefore: 'Proses',
    processTitleHighlight: 'Pembangunan',
    consultationAlt: 'Perundingan',
    process: [
      {
        step: '01',
        title: 'Perundingan',
        desc: 'Kami duduk bersama untuk memahami cabaran dan matlamat perniagaan anda.',
      },
      {
        step: '02',
        title: 'Strategi & UX',
        desc: 'Kami merangka perjalanan pengguna dan seni bina sistem.',
      },
      {
        step: '03',
        title: 'Pembangunan Lincah',
        desc: 'Binaan pantas dengan gelung maklum balas yang telus.',
      },
      {
        step: '04',
        title: 'Lancarkan & Sokongan',
        desc: 'Kami membimbing pasukan anda melalui onboarding dan skala selepas pelancaran.',
      },
    ],
    ctaTitle: 'Bersedia untuk Mendigitalkan Perniagaan Anda?',
