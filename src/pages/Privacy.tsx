    ...
    <div className="pt-20">
      ...
      <SectionBlock title={p.relatedTitle}>
        <ul className="space-y-3">
          ...
          <li>
            <Link to="/cookie-settings" className="font-semibold text-primary">
              {t.nav.cookies}
            </Link>
          </li>
          <li>
            <Link to="/contact?tujuan=privasi-data" className="font-semibold text-primary">
              {t.contact.types.find((item) => item.id === 'privasi-data')?.title ?? t.nav.contact}
            </Link>
          </li>
        </ul>
      </SectionBlock>
